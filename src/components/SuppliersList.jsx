            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                {suppliers?.map((supplier) => (
                    ...
                    >
                        ...
                        <p className="text-gray-600 mb-1"><strong>Contact Person:</strong> {supplier.contactPerson}</p>
                        <p className="text-gray-600 mb-1"><strong>Email:</strong> <a href={`mailto:${supplier.email}`} className="text-blue-500 hover:underline">{supplier.email}</a></p>
                        <p className="text-gray-600 mb-1"><strong>Phone:</strong> <a href={`tel:${supplier.phone}`} className="text-blue-500 hover:underline">{supplier.phone}</a></p>
